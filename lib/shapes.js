...
class Square extends Shape {
    ...
    render() {
        ...
        width="300" height="200"
            xmlns="http://www.w3.org/2000/svg">
            <rect width="50%" height="70%" fill="${this.shapeColor}" />
            <text x="75" y="85" font-size="50" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`
    };
};
...
class Triangle extends Shape {
    ...
    render() {
        ...
        <svg version="1.1"
            ...
            <text x="145" y="150" font-size="50" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`
    };
};
